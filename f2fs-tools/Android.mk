...
#ifdef VENDOR_EDIT
#Wei.Wang@PSW.AD.Storage.FileSystem.F2fs.1054207, 2017/02/17, Add for support f2fs
ifeq ($(OPPO_USE_F2FS), true)
#----------------------------------------------------------
include $(CLEAR_VARS)
# The LOCAL_MODULE name is referenced by the code. Don't change it.
...
LOCAL_CFLAGS := $(common_CFLAGS) -D_CORETECH_ANDROID_RESIZE_ -DWITH_RESIZE
